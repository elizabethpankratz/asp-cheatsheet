...
\begin{center}
	\begin{tabular}{rll}
	$\Delta_P =$ 	& $\{ \{ \ngfa{\text{head}}, \ngtb{\text{body}} \},$ & (per rule) \\
					& $\{ \ngta{\text{head}}, \ngtb{\text{body 1}}, \ngtb{\text{body n}} \},$ & (containing bodies of all rules sharing a head) \\
					& $\{ \ngtb{\text{body}}, \ngfa{\text{body atom}} \},$ & (per atom in each body)\\
					& $\{ \ngfb{\text{body}}, \ngta{\text{body atom 1}}, \ngta{\text{body atom n}} \} \}$ & (containing all atoms in one body)
\end{tabular}
\end{center}
